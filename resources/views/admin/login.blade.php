...
<head>
    ...
    <link rel="shortcut icon" type="image/png" href="{{ asset('back/srtdash-admin-dashboard-master/srtdash/assets/images/icon/favicon.ico') }}">
    ...
    <!-- modernizr css -->
    <script src="{{ asset('back/srtdash-admin-dashboard-master/srtdash/assets/js/vendor/modernizr-2.8.3.min.js') }}"></script>
</head>
            ...
            <div class="login-box ptb--100">
                <form action="login" method="POST">
                    ...
                    <div class="login-form-head">
                        <h4>Sign In</h4>
                        <p>Masukkan Akun Admin Anda Terlebih Dulu</p>
                    </div>
                    <div class="login-form-body">
                        <div class="form-gp">
                            <label for="exampleInputEmail1">Email</label>
                            <input type="email" name="email" value="{{ Session::get('email') }}" id="exampleInputEmail1">
                            <i class="ti-email"></i>
                            <div class="text-danger"></div>
                        </div>
                        <div class="form-gp">
                            <label for="exampleInputPassword1">Password</label>
                            <input type="password" name="password" value="{{ Session::get('password') }}" id="exampleInputPassword1">
                            <i class="ti-lock"></i>
                            <div class="text-danger"></div>
                        </div>
